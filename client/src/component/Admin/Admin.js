...
class Admin extends Component {
  ...
  onSubmit2(e) {
    ...
    axios
      .post("/admin/delete", { admin_id: this.state.del_emp_id })
      .then((res) => {
        alert(res.data);
        console.log(res.data);
        return res.data;
              ...
              >
                <form noValidate onSubmit={this.onSubmit1}>
                  <div className="col-sm-6">
                    <h2 className="text-primary">Add New Admin</h2>
                  </div>
                  <br />
            ...
            <div className="container mr-3">
              ...
              >
                <form noValidate onSubmit={this.onSubmit2}>
                  <div className="col-sm-6">
                    <h3 className="text-primary">Delete Admin Information</h3>
                  </div>
                  <br />
                  <div className="form-group">
